...
boys.each do |boy|
  ...
  nba1 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 3, 18).strftime("%b %-d"),
    author_id: admin.id,
  ...
  story5 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 3, 20).strftime("%b %-d"),
    author_id: user5.id,
  ...
  food1 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 3, 25).strftime("%b %-d"),
    author_id: user2.id,
  ...
  published: true,
  published_at: Date.new(2017, 3, 31).strftime("%b %-d"),
  author_id: admin.id,
  ...
  food2 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 4, 5).strftime("%b %-d"),
    author_id: user2.id,
  ...
  nba3 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 4, 6).strftime("%b %-d"),
    author_id: admin.id,
  ...
  travel3 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 4, 10).strftime("%b %-d"),
    author_id: user5.id,
  ...
  published: true,
  published_at: Date.new(2017, 4, 12).strftime("%b %-d"),
  author_id: admin.id,
  ...
  travel4 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 4, 14).strftime("%b %-d"),
    author_id: user6.id,
  ...
  food4 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 4, 17).strftime("%b %-d"),
    author_id: user2.id,
  ...
  published: true,
  published_at: Date.new(2017, 4, 18).strftime("%b %-d"),
  author_id: user6.id,
  ...
  food5 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 4, 19).strftime("%b %-d"),
    author_id: user2.id,
  ...
  nba2 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 4, 20).strftime("%b %-d"),
    author_id: admin.id,
  ...
  nba5 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 4, 21).strftime("%b %-d"),
    author_id: admin.id,
...
Oh, I just can't wait to be king!",
    published: true,
    published_at: Date.new(2017, 4, 22).strftime("%b %-d"),
    author_id: user3.id,
...
'Oh look - I'm opening my box of care! Oh wait - it's empty!'",
    published: true,
    published_at: Date.new(2017, 4, 23).strftime("%b %-d"),
    author_id: admin.id,
  ...
  food3 = Story.create(
    ...
    published: true,
    published_at: Date.new(2017, 4, 24).strftime("%b %-d"),
    author_id: user2.id,
